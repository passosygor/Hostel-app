# 📋 HostelApp — Documentação Completa do Sistema
...
2. Crie um novo banco de dados chamado `hotel-db`:
   - Clique com botão direito em "Databases" → Create → Database
   - Name: `hotel-db` → Save
3. Abra o Query Tool com o banco `hotel-db` selecionado.
4. Cole e execute o conteúdo do arquivo `hotel-db.sql` (script completo já com seeds).
